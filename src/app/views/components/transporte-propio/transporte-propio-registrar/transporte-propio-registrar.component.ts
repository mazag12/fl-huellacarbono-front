...
@Component({
  selector: 'app-transporte-propio-registrar',
  templateUrl: './transporte-propio-registrar.component.html',
  styleUrls: ['./transporte-propio-registrar.component.scss']
})
export class TransportePropioRegistrarComponent implements OnInit {
  constructor(
