...
import { ConsumoSeinComponent } from '../../fna/consumo-sein/consumo-sein.component';

@Component({
  selector: 'app-generacion-electricidad-reporte',
  templateUrl: './generacion-electricidad-reporte.component.html',
  styleUrls: ['./generacion-electricidad-reporte.component.scss']
})
export class GeneracionElectricidadReporteComponent{
  ...
  ngOnInit(): void{
    ...
    .subscribe( combustible =>  {
      combustible.data.forEach(combustibles => {
        ...
        this.electricidadservice.obtener_Electricidad(1000,1)
